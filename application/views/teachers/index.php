...
<body class="bg-light">
            ...
            <div class="collapse navbar-collapse" id="dashNav">
                ...
                <ul class="navbar-nav ms-auto align-items-center">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <a class="nav-link dropdown-toggle text-white d-flex align-items-center gap-2 pe-0"
                            href="#"
                            id="userDropdown"
                            role="button"
                ...
                <form action="<?= site_url('teachers'); ?>"
                    ...
                    <div class="col-md-auto d-flex gap-2">
                        ...
                        <?php if (!$has_filters): ?>
                            ...
                            <button type="submit"
                                class="btn btn-success text-nowrap fw-semibold">
                        ...
                        <?php else: ?>
                            ...
                            <a href="<?= site_url('teachers'); ?>"
                                class="btn btn-outline-success text-nowrap fw-semibold">
    ...
    <script>
        const teacherSearchUrl = '<?= site_url('teachers/search_ajax'); ?>';
        const teacherViewUrl = '<?= site_url('teachers/view_ajax/'); ?>';
        const teacherEditUrl = '<?= site_url('teachers/edit/'); ?>';
    </script>

    <script src="<?= base_url('application/assets/js/teachers.js'); ?>"></script>
