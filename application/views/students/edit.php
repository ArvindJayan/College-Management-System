    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-success shadow-sm sticky-top">
        <div class="container">
            <a class="navbar-brand fw-bold d-flex align-items-center" href="<?= site_url('/dashboard'); ?>">
                <i class="bi bi-hospital fs-3 me-2"></i> CMS Portal
            </a>
            ...
            <div class="col-lg-6 col-md-8">
                <div class="card border-0 shadow rounded-3">
                    <div class="card-header bg-success text-white py-3">
                        <h5 class="mb-0 fw-bold"><i class="bi bi-pencil-square me-2"></i>Edit Student Record</h5>
                    </div>
                        ...
                        <form action="<?= site_url('students/edit/' . $student->id); ?>" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="tel" name="phone" maxlength=10 minlength=10 class="form-control"
                                    value="<?= set_value('phone', $student->phone); ?>" required>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="date" name="dob" class="form-control"
                                        value="<?= set_value('dob', $student->dob); ?>" required>
                                </div>
                            </div>

                            <div class="d-flex justify-content-end gap-2">
                                <a href="<?= site_url('students'); ?>"
                                    class="btn btn-outline-success fw-semibold">Cancel</a>
