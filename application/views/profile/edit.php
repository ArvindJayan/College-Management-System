    ...
    <div class="container py-5">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div>
                ...
                <a href="<?= site_url('/profile'); ?>" class="btn btn-outline-success fw-semibold">
                ...
                <div class="card-body px-4 pb-4">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="name" name="name" maxlength="50" value="<?= html_escape(
                                set_value(
                                    'name',
                                    $user->name
                                )
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="email" class="form-control" id="email" name="email" maxlength="100" value="<?= html_escape(
                                set_value(
                                    'email',
                                    $user->email
                                )
                    ...
                    <div class="card-body px-4 pb-4">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" class="form-control" id="dob" name="dob" value="<?= html_escape(
                                    set_value(
                                        'dob',
                                        $user->student->dob
                                    )
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select" id="gender" name="gender">
                                    ...
                                    <option value="female" <?= set_select(
                                        'gender',
                                        'female',
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="phone" name="phone" maxlength="20" value="<?= html_escape(
                                    set_value(
                                        'phone',
                                        $user->student->phone
                                    )
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" class="form-control" value="<?= html_escape(
                    ...
                    <div class="card-body px-4 pb-4">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <label for="teacher_phone" class="form-label fw-semibold">
                                ...
                                <input type="text" class="form-control" id="teacher_phone" name="teacher_phone"
                                    maxlength="20" value="<?= html_escape(
                                        set_value(
                                            'teacher_phone',
                                            $user->teacher->phone
                                        )
