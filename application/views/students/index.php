...
<script>
    const studentSearchUrl = '<?= site_url('students/search_ajax'); ?>';
    const studentEditUrl = '<?= site_url('students/edit/'); ?>';
    const studentViewUrl = '<?= site_url('students/view_ajax/'); ?>';
</script>

<script src="<?= base_url('application/assets/js/students.js'); ?>"></script>
