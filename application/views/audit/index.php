                            ...
                            <ul class="pagination pagination-sm mb-0">
                                ...
                                <?php if ($current_page > 1): ?>
                                    ...
                                    <li class="page-item">
                                        ...
                                        <a class="page-link" href="<?= site_url('audit') . '?page=' . ($current_page - 1); ?>">
                                ...
                                <?php for ($page = 1; $page <= $total_pages; $page++): ?>
                                    ...
                                    <li class="page-item <?= $page === $current_page ? 'active' : ''; ?>">
                                        ...
                                        <a class="page-link" href="<?= site_url('audit') . '?page=' . $page; ?>">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row g-3 mb-4">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="mt-1" title="<?= html_escape($log->user_agent); ?>">
