                        ...
                        <div class="card-body text-center p-4">
                            ...
                            <p class="text-muted small">
                                <?= ($role_id === 1)
                                    ...
                                    : 'Browse and modify student details.'; ?>
                            </p>
            ...
            <div class="col-md-4">
                <div class="card h-100 shadow action-card p-2">
                    <div class="card-body text-center p-4">
                        ...
                        <p class="text-muted small">
                            <?= ($role_id === 4)
                                ? 'View courses and their information.'
                ...
                <div class="col-md-4">
                    <div class="card h-100 shadow action-card p-2">
                        <div class="card-body text-center p-4">
                            ...
                            <h5 class="fw-bold">List of Subjects</h5>
                            <p class="text-muted small">
                        ...
                        <div class="card-body text-center p-4">
                            ...
                            <p class="text-muted small">
                                <?= ($role_id === 4)
                                    ...
                                    : 'View, edit and mark student attendance.'; ?>
                            </p>
                            <a href="<?= site_url('/attendance'); ?>" class="btn btn-success w-100 mt-2 fw-semibold">
                                <?= ($role_id === 4)
                                    ? 'View Attendance'
                                    : 'Manage Attendance'; ?>
                            </a>
