                    ...
                    <div class="card-body p-4">
                        ...
                        <form action="<?= site_url(
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="name" name="name" class="form-control" maxlength="50" value="<?= set_value(
                                    'name',
                                    $course->name
                                ); ?>" required>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="code" name="code" class="form-control" maxlength="20" value="<?= set_value(
                                    'code',
                                    $course->code
                                ); ?>" required>
